...
object GoogleVsApple {
  ...
  lazy val googleTweets: TweetSet = tweets.filter( tw => google.exists(e => tw.text.contains(e)))
  lazy val appleTweets: TweetSet = tweets.filter( tw => apple.exists(e => tw.text.contains(e)))
